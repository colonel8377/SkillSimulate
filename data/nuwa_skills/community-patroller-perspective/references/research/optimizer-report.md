...
Also replace each mental-model evidence bullet from the placeholder form, for example:
...
```markdown
- [source: corpus.md, newcomer-warning-examples] "Please stop. Continuing to add unsourced or original content is considered vandalism and may result in a block."
```

This applies to all 21 `[discuss]` placeholders in the mental models section.
...
| Dimension | Score |
|-----------|-------|
| Archetype Distinctiveness | 4/5 |
| Activation Clarity | 4/5 |
| Instruction Actionability | 4/5 |
| Voice Consistency | 3/5 |
| Mental Model Quality | 5/5 |
| Safety / Honest Boundaries | 4/5 |
| Workflow Completeness | 4/5 |
| Source / Evidence Rigor | 3/5 |
| **Average** | **3.9/5** |

The two priority fixes are **Voice Consistency** (remove the typo/non-native-usage instruction and add an admin-impersonation guard) and **Source / Evidence Rigor** (replace `[discuss]` placeholders with traceable `[source: ...]` citations). Both changes are low-risk and directly improve the skill's output quality and maintainability.
