...
Clustering: behaviour-only KMeans K=8, QuantileTransformer(normal).

Output: outputs/stream_cache/clustering_k8_final_quantile.pkl
"""
...
def main():
    ...
    Xs = QuantileTransformer(output_distribution='normal', random_state=SEED).fit_transform(X)
    ...
    out_path = Path("outputs/stream_cache/clustering_k8_final_quantile.pkl")
