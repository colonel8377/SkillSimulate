"""
Generate final K=4 cluster result from the locked clustering decision.
...
Clustering: behaviour-only KMeans K=4, RobustScaler(5-95).

Output: outputs/stream_cache/clustering_k4_final.pkl
"""
...
def main():
    ...
    out_path = Path("outputs/stream_cache/clustering_k4_final.pkl")
